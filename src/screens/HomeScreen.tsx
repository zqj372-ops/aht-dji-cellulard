...
export function HomeScreen({ inbox, agents, onOpen }: HomeScreenProps) {
  ...
  return (
    <section aria-labelledby="home-heading" data-testid="home-screen" data-screen="home">
      <div className="screen-heading home-summary" data-testid="home-summary">
        <div>
          <h1 id="home-heading">现在需要你</h1>
          <p>Agent 有 {pendingItems.length} 个事项等待处理</p>
        </div>
        <div className="home-summary__count"><strong>{pendingItems.length}</strong><span className="screen-count-label">待处理</span></div>
      </div>
