...
- [x] **Step 3: Add exact protocol and provider contracts**
...
- [x] **Step 3: Move fixture authority behind the provider**
...
- [x] **Step 4: Run provider and regression tests GREEN**
...
- [x] **Step 1: Write failing reducer and fake-socket tests**
...
- [x] **Step 3: Implement minimal protocol loop**
...
- [x] **Step 1: Write failing runtime switch tests**
...
- [x] **Step 3: Add runtime hook and truthful status UI**
...
- [x] **Step 4: Run runtime and existing tests GREEN**
...
- [x] **Step 1: Write failing A/X and harness tests**
...
- [x] **Step 3: Implement context-aware shortcuts and local reference server**
...
- [x] **Step 2: Start both local services**

Run Vite at `http://127.0.0.1:4173/` and reference Gateway at `ws://127.0.0.1:8787`.

- [x] **Step 3: Use Browser for the target flow**
...
- [x] **Step 4: Write the verification record**
...
- [x] **Step 5: Commit the V0.2 slice**
